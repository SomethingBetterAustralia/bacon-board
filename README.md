...
Hollywood worked out that everyone on Earth is [six handshakes from Kevin Bacon](https://en.wikipedia.org/wiki/Six_Degrees_of_Kevin_Bacon). Bacon Board points those handshakes somewhere useful. [Something Better Australia](https://somethingbetteraustralia.com) (SBA) — an evidence-led grassroots movement working toward Australia's next major political party has some big dreams of who we want to be part of this process and the people we'd like to help shape it. 
We'll name a person (or perhaps a coversation theme) we want to chat to, and the community plays a forwarding game to bridge us to those people or thought-leaders through their own networks. No cold messages. No mass campaigns. Community-governed, built in public.
...
1. **SBA lists a quest, by description.** Someone they'd like to talk to — an expertise described or person named, while the endorsement is in motion.
